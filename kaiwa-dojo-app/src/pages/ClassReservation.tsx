  ...
  return (
    <div className="flex-1 p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto w-full flex flex-col gap-6 animate-page-slide">
      ...
      {confirmModalType && targetSchedule && (
        <div className="fixed inset-0 bg-slate-900/70 backdrop-blur-sm z-[999] flex flex-col p-4 animate-fade-in overflow-y-auto">
          <div className="bg-white dark:bg-slate-900 w-full max-w-md rounded-2xl sm:rounded-3xl p-5 sm:p-6 shadow-2xl border border-slate-200 dark:border-slate-800 flex flex-col gap-4 sm:gap-5 animate-scale-up my-auto mx-auto max-h-[90dvh] overflow-y-auto">
