    ...
    <>
      ...
      <div className="fixed bottom-5 right-5 sm:bottom-6 sm:right-6 z-50 flex items-center gap-2 group">
        ...
        >
          ...
          {/* WhatsApp SVG Icon */}
          <svg className="size-7 sm:size-8 fill-current relative z-10" viewBox="0 0 24 24">
